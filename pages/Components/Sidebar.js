...
const Sidebar = () => {
  return (
    <div className="p-7 w-64">
      <div>
        <svg viewBox="0 0 1134 340" className="h-11">
      ...
      <div className="text-sm font-semibold py-10 space-y-4">
        <div className="flex space-x-4 items-center hover:text-white">
          <span><Home set="bold" primaryColor="white"/></span>
          <h3>Home</h3>
        </div>
        <div className="flex space-x-4 items-center hover:text-white text-slate-300">
          <span><Search primaryColor="gray"/></span>
          <h3>Search</h3>
        </div>
        <div className="flex space-x-4 items-center hover:text-white text-slate-300">
          <span><Category set="bold" primaryColor="gray"/></span>
          <h3>Your Library</h3>
        </div>
      </div>
    </div>
