...
const Sidebar = () => {
  return (
    <div className="p-7 w-64">
      <div>
        <svg viewBox="0 0 1134 340" class="h-11">
      ...
      <div className="text-sm font-semibold py-10 space-y-4">
        <div className="flex space-x-4 items-center active:text-white">
          <span><Home set="bold" primaryColor="white"/></span>
          <h3>Home</h3>
        </div>
        <div className="flex space-x-4 items-center active:text-white text-slate-300">
